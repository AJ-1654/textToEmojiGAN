...
def generate_from_caption(caption):
    ...
    generated_image.save('./images/myImages/' + str(caption) + '.png')
    print('done')
    
    
def generate_from_caption1(captions):
    img_size = (64, 64, 3)
    img_path = './emoji/edited/emoji_64x64/'
    txt_path = './emoji/description/detailed'
    glove_path = './utils/glove.6B.300d.txt'
...
if __name__ == '__main__':
    if sys.argv[1] == '3':
        ...
        captions = []
        for i in range(2,l):
            captions.append(sys.argv[i])
        generate_from_caption1(captions)
